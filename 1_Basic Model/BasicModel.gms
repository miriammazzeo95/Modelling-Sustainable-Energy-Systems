...
*i        Capacities      /Turbine, Generator,Plant, Inverter,...
*                          Charging, Storing, Discharging/
*a(i) Wind farm costs  /Turbine           33.787
*                       Generator         10.136/


*b(i) PV plant    /Plant        101.3606
*                  Inverter       8.7845/

*c(i) Storage costs       /Charging       5.068
*                          Storing        0.06757
*                          Discharging    15.204/
...
Wprod(t)..               pw(t)=e=w(t)*a1w;
Pvprod(t)..              ppv(t)=e=p(t)*a1pv;
